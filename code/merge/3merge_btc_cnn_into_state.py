...
# ---------- Paths ----------
STATE_IN  = Path("data/processed/state/btcusd_state_with_macro_30m_2019_2023.parquet")
STATE_META_IN = Path("data/processed/state/btcusd_state_with_macro_30m_2019_2023.meta.json")

CNN_CSV   = Path("data/model/cnn_price/cnn_price_embeddings_BTCUSDT.csv")

STATE_OUT = Path("data/processed/state/btcusd_state_with_macro_cnn_30m_2019_2023.parquet")
STATE_META_OUT = Path("data/processed/state/btcusd_state_with_macro_cnn_30m_2019_2023.meta.json")
