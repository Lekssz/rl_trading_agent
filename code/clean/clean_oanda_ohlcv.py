...
Input : data/raw/oanda_EURUSD_M30_2019-2023.csv
Output: data/processed/oanda_EURUSD_M30_2019-2023_processed.csv

References (Harvard):
OANDA (2024) v20 REST API – Instruments: Candles. Available at:
https://developer.oanda.com/rest-live-v20/instrument-ep/ (Accessed: 15 October 2025)
Pandas (2024) pandas.to_datetime. Available at:
https://pandas.pydata.org/ (Accessed: 15 October 2025)
"""

import pandas as pd
from pathlib import Path

RAW_PATH   = Path("data/raw/ohlcv/oanda_EURUSD_M30_2019-2023.csv")
CLEAN_PATH = Path("data/processed/ohlcv/oanda_EURUSD_M30_2019-2023_processed.csv")
